...
dir_data = 'D:\Scratch\bCFS_EEG_Reanalysis\data\Exp2\Behavioural'; % location of raw data files (e.g. s1_trial_info.mat)
...
block_include = 1:14; % blocks to analyse (i.e. could exclude first 2 for learning)
...
header_names = {'Subject','Gender','Age','STAI','State','Trait',...
                'Order','Block','ExpTrial','BlockTrial','SurpriseIdx','Emotion','Expectation','RT','Response'};        
            
commaHeader = [header_names; repmat({','}, 1, numel(header_names))]; %insert commaas
textHeader = cell2mat(commaHeader(:)'); %cHeader in text with commas

filename = fullfile(dir_results,'trial_data_exp2.csv');
